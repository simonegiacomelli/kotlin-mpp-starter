...
"""
    ...
    private val table1 by this{ GridWidget<AcUser>().addSearchToolbar() }

    override fun afterRender(): Unit = state.spinner {
        ...
        table1.onElementClick = { show(UserEditWidget(element) { afterRender() }) }
