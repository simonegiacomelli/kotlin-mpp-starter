...
class LocalDateTimeBridgeN(override val target: HTMLElement) : PropertyBridge<LocalDateTime?>, HtmlElementObservable {
...
class LocalDateTimeBridge(override val target: HTMLElement) : PropertyBridge<LocalDateTime>,
